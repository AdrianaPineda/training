...
func minimumSwaps(arr: [Int]) -> Int {
    ...
    for i in 0..<updatedArray.count {
        ...
        swapPositions(i: i, itemPosI: expectedItem, j: currItemNewPos, itemPosJ: currItem, arr: &updatedArray, indexes: &elementsIndexes)
...
func swapPositions(i: Int, itemPosI: Int, j: Int, itemPosJ: Int, arr: inout [Int], indexes: inout[Int: Int]) {
    arr[i] = itemPosI
    indexes[itemPosI] = i
